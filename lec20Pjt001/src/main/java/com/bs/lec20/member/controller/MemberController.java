...
public class MemberController {
	 ...
	 * memLogin(Member member, HttpServletRequest request) {
	 * 
	 * Member mem = service.memberSearch(member);
	 * 
	 * HttpSession session = request.getSession(); // 속성의 이름, 속성 값(회원정보)
	 * session.setAttribute("member", mem);
	 * 
	 * return "/member/loginOk"; }
	 */

	// HttpSession을 사용하면 getSession 절차 필요 없음
	...
	// Logout
	// session.invalidate() : 세션 삭제 (로그아웃, 탈퇴)
	/*
	 * @RequestMapping("/logout") public String memLogout(Member member,
